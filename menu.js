...
const libro1 = new Libros(`Aki Shamazaki`, `Luna LLena`, 228,`Pesos`)
const libro2 = new Libros(`Roberto Martinez`, `El arte de perder`, 239,`Pesos`)
const libro3 = new Libros(`Joana Marcus`, `Antes de Diciembre`, 329,`Pesos`)
const libro4 = new Libros(`Paloma Sanchez`, `Ultimos dias en Berlin`, 348,`Pesos`)
const libro5 = new Libros(`Flor M. Salvador`, `Boulevard`, 329,`Pesos`)
...
function presentacion() {
    ...
    while (nombre == "") {
        nombre = prompt(`Tiene que colocar nombre de favor `)
    }
    alert(`Hola ${nombre}, en este momento probaras un simulador de un menu dinamico.`)
}

function opcionSwitch() {
    let elegirOpcion = parseInt(prompt(`Elige una de las siguientes opciones: 1. Ver catálogo de libros      2. Agregar un nuevo libro al catálogo   3. Buscar libro por titulo       4. Buscar libro por precio   5. Buscar libro por autor       6. Ver titulos incluidos en el catálogo    7. Ordenar catalogo de menor a mayor precio   8. Eliminar un libro del catalogo     9. Agregar libros al carrito    0. Salir del programa`))
    switch (elegirOpcion) {
        case 1:
            verCatalogoLibros()
            break;
        ...
        case 9:
            ...
            break;
        case 0: 
            alert(`Gracias por probar mi simulador`)
            break;
        default:
...
function buscarTitulo() {
    ...
    if (nombreTitulo.toUpperCase() == null) {
        opcionSwitch()
    }
    while (nombreTitulo == "") {
...
function buscarAutor() {
    ...
    if (nombreAutor.toUpperCase() == null) {
        opcionSwitch()
    }
    while (nombreAutor == "") {
        nombreTitulo = prompt(`Debe ingresar un nombre para la busqueda: `) 
